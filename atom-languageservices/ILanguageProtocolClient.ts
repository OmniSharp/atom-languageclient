...
import { NotificationHandler, NotificationType, RequestHandler, RequestType } from 'vscode-jsonrpc';
...
export interface ILanguageProtocolClient {
    ...
    sendRequest<P, R, E>(type: RequestType<P, R, E>, params: P): Observable<R>;
