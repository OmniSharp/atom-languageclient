...
@capability
export class LanguageProtocolWorkspaceSymbols {
    ...
    constructor(
        ...
        this._finderService.registerProvider(new FinderService(client));
    }
}

export class FinderService extends DisposableBase implements IFinderProvider {
    private _client: ILanguageProtocolClient;
